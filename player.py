...
playerOne = 1
playerOneColor = (255, 69, 0)
playerTwo = 2
playerTwoColor = (0, 255, 255)
bottomMsg = ""
msg = "Waiting for next player"
currentPlayer = 0
xy = (-1, -1)
...
def validate_input(x, y):
    if x > 3 or y > 3:
        print("\nWrong location!  Enter again inside box...\n")
        return False
    elif matrix[x][y] != 0:
        print("\nAlready entered! Try again in an empty box...\n")
        return False
    return True
    ...
    while True:
        try: 
            ...
            if recvDataDecode == "Input":
                ...
                msg = "Finish. Restart To Play Again!"
